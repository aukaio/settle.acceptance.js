(function () {
    ...
    describe('settle.acceptance.js', function () {
        ...
        it('creates a QR button from an id', function () {
            ...
            button.click();
            expect(Settle.redirect_to).toHaveBeenCalledWith('http://get.settle.eu?link=settle://qr?code=http://settle.eu/s/moo/&apn=eu.settle.app&ibi=eu.settle.app&isi=1440051902&ius=eu.settle.app.firebaselink');
        });
        ...
        it('creates a QR button from an id and an argstring', function () {
            ...
            button.click();
            expect(Settle.redirect_to).toHaveBeenCalledWith('http://get.settle.eu?link=settle://qr?code=http://settle.eu/s/moo/far&apn=eu.settle.app&ibi=eu.settle.app&isi=1440051902&ius=eu.settle.app.firebaselink');
        });
        ...
        it('creates a custom shortlink', function () {
            ...
            button.click();
            expect(Settle.redirect_to).toHaveBeenCalledWith('http://get.settle.eu?link=settle://qr?code=http://settle.eu/q/foo/&apn=eu.settle.app&ibi=eu.settle.app&isi=1440051902&ius=eu.settle.app.firebaselink');
        });
